...
#' @param mu Either the population mean or a sequence of values guessing at it
#' @param sig Either the population std deviation or a sequence of values guessing at it
#' @param ...
#'
#' @return Calculations giving results as well as a graph
#' @export
#'
#' @examples
